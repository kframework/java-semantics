...
time timeout 300 krun --debug-info --color extended --directory="." --main-module=JAVA \
  -cMainClass="ListItem(\"symbolic_04_OrderedList\")" \
  -cDissolveAllExceptOut="false" --output=pretty --parser="kj-parse-aggreg.sh" \
  ../symbolic/symbolic_04_OrderedList.java \
...
public class symbolic_04_OrderedList {
