/*
Inner class access modes for inherited methods. (Similar to static inner test 108)
  p1.A:
    - private f(byte)
    - package f(short)
    - protected f(int)
...
public class inner_in_51_access_modes_hier {

  public static void main(String[] args) {
    p1.A.Inner1 inner1 = new p1.A().new Inner1();
    p1.B.Inner2 inner2 = new p1.B().new Inner2();
    p1.TestP1.Inner3 inner3 = new p1.TestP1().new Inner3();
    p1.TestP1.Inner4 inner4 = new p1.TestP1().new Inner4();
    TestDef.Inner5 inner5 = new TestDef().new Inner5();
    TestDef.Inner6 inner6 = new TestDef().new Inner6();
