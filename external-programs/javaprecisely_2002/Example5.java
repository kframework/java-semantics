...
class Example5 {
  ...
  static void equalityAndPlus() {
    ...
    //Java semantics: This check returns incorrect result because strings are special primitive types, not objects.
    //In present java semantics there is no distinction between s1 == s2 and s1.equals(s2).
