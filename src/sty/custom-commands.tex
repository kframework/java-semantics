...
% Default \kall color is white (\mcell turns it to gray), we want it to be black.
% Required in order to make all \kall cells in math mode black (especially inside comments).
\renewcommand{\mall}[3]{\ifthenelse
	{\equal{#1}{white}}
	{\mcell{black}{#2}{#3}}
	{\mcell{#1}{#2}{#3}}
}
